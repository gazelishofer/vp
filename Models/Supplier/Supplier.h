...
public:
    ...
    void setProductName(string n) {
        if (product) product->setName(n);
    }

    void setProductType(string t) {
        if (product) product->setType(t);
    }

    void setProductPrice(int p) {
        if (product) product->setPrice(p);
    }

    void setProductAmount(int a) {
        if (product) product->setAmount(a);
    }
    ...
    string getProductType() {
        return product ? product->getType() : "";
    }
    ...
    int getProductAmount() {
        return product ? product->getAmount() : 0;
    }
